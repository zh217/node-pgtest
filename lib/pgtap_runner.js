            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 7];
                    case 7:
                        console.log(chalk_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["{white DONE {gray in} {blue ", "}{gray ms}}"], ["{white DONE {gray in} {blue ", "}{gray ms}}"])), '' + (Date.now() - startAt)));
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        startAt = Date.now();
                        process.stdout.write(chalk_1.default(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{white NUKE {gray with ", "}}"], ["{white NUKE {gray with ", "}}"])), this.config.nukeScript));
                    ...
                    case 1:
                        _a.sent();
                        console.log(chalk_1.default(templateObject_3 || (templateObject_3 = __makeTemplateObject(["{gray  in {blue ", "}ms}"], ["{gray  in {blue ", "}ms}"])), '' + (Date.now() - startAt)));
                        if (runner.stderrData.length) {
                            console.log(chalk_1.default(templateObject_4 || (templateObject_4 = __makeTemplateObject(["{red ", "}"], ["{red ", "}"])), runner.stderrData.join('')));
                        }
                        if (!runner.exitOk) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        startAt = Date.now();
                        process.stdout.write(chalk_1.default(templateObject_5 || (templateObject_5 = __makeTemplateObject(["{white INIT {gray with ", "}}"], ["{white INIT {gray with ", "}}"])), this.config.initScript));
                        runner = new psql_runner_1.PSqlRunner(this.runnerConfig, ['-f', INIT_PREAMBLE, '-f', this.config.initScript]);
                        return [4 /*yield*/, runner.joinRunner()];
                    case 1:
                        _a.sent();
                        console.log(chalk_1.default(templateObject_6 || (templateObject_6 = __makeTemplateObject(["{gray  in {blue ", "}ms}"], ["{gray  in {blue ", "}ms}"])), '' + (Date.now() - startAt)));
                        if (runner.stderrData.length) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        startAt = Date.now();
                        process.stdout.write(chalk_1.default(templateObject_8 || (templateObject_8 = __makeTemplateObject(["{white PREP {gray with ", "}}"], ["{white PREP {gray with ", "}}"])), this.config.testScript));
                        runner = new psql_runner_1.PSqlRunner(this.runnerConfig, ['-f', INIT_PREAMBLE, '-f', TEST_SETUP, '-f', this.config.testScript]);
                        return [4 /*yield*/, runner.joinRunner()];
                    case 1:
                        _a.sent();
                        console.log(chalk_1.default(templateObject_9 || (templateObject_9 = __makeTemplateObject(["{gray  in {blue ", "}ms}"], ["{gray  in {blue ", "}ms}"])), '' + (Date.now() - startAt)));
                        if (runner.stderrData.length) {
                            console.log(chalk_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["{red ", "}"], ["{red ", "}"])), runner.stderrData.join('')));
                        }
                        if (!runner.exitOk) {
    ...
    PgTapRunner.prototype.runTest = function (test) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        process.stdout.write(chalk_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject(["{white TEST {gray ", "}} "], ["{white TEST {gray ", "}} "])), test));
                    ...
                    case 2:
                        result = _a.sent();
                        if (runner.stderrData.length) {
                            console.log(chalk_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["{red ", "}"], ["{red ", "}"])), runner.stderrData.join('')));
                        }
                        if ((!result || runner.stderrData.length) && this.config.stopOnError) {
                            console.log(chalk_1.default(templateObject_13 || (templateObject_13 = __makeTemplateObject(["{white STOP {gray on failure in }{white ", "}}"], ["{white STOP {gray on failure in }{white ", "}}"])), test));
