...
var PgTapRunner = /** @class */ (function () {
    function PgTapRunner(config, runner, reporter) {
        this.config = config;
        this.runner = runner;
    ...
    PgTapRunner.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.config.bareRun) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.prepare()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!(!this.config.initOnly || !this.config.nukeOnly)) return [3 /*break*/, 4];
    ...
    PgTapRunner.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
