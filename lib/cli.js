...
console.log(chalk_1.default(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{white > TESTING postgresql database with config {bold ", "}}"], ["{white > TESTING postgresql database with config {bold ", "}}"])), userConfigPath));
